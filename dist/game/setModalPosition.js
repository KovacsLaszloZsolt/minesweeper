...
export const setModalPosition = (e, modal) => {
    ...
    const rowIndex = parseInt(clickedField.dataset.position?.split('-')[0]);
    const index = parseInt(clickedField.dataset.position?.split('-')[1]);
